...
class _$NoteImpl implements _Note {
  ...
  @override
  String toString() {
    return 'Note(id: $id, title: $title, content: $content, createdAt: $createdAt, isCompleted: $isCompleted)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, title, content, createdAt, isCompleted);
...
abstract class _Note implements Note {
  const factory _Note(
      ...
      @HiveField(4) final bool isCompleted}) = _$NoteImpl;
